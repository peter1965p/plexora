...
const translations = {
  de: {
    ...
    shop: {
      ...
      tabStock: 'Bestand', tabOrders: 'Wareneingang', tabSales: 'Verkäufe',
      ...
      orders: 'Wareneingänge', openOrders: 'offen',
      orderNumber: 'Bestell-Nr.', quantity: 'Menge', units: 'Stk.', noOrders: 'Keine Wareneingänge vorhanden',
      confirmOrder: 'Als bestätigt markieren', confirmDelivery: 'Als geliefert markieren',
      noSales: 'Keine Bestellungen vorhanden', returnBtn: 'Retoure', returnModalTitle: 'Retoure erfassen',
      returnReason: 'Grund (optional)', returnSubmit: 'Retoure abschließen', returnQty: 'Menge',
      ...
      newSupplierTitle: 'Neuer Lieferant', editSupplierTitle: 'Lieferant bearbeiten', companyName: 'Firmenname *',
  ...
  en: {
    ...
    shop: {
      ...
      tabStock: 'Inventory', tabOrders: 'Incoming Stock', tabSales: 'Sales',
      ...
      noSales: 'No orders yet', returnBtn: 'Return', returnModalTitle: 'Record Return',
      returnReason: 'Reason (optional)', returnSubmit: 'Complete Return', returnQty: 'Qty',
      ...
      newSupplierTitle: 'New Supplier', editSupplierTitle: 'Edit Supplier', companyName: 'Company Name *',
