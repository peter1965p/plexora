  ...
  <div class="page">
    ...
    <div v-if="tab === 'security'" class="card">
      <div class="card-header">
        ...
        <button class="accent-btn" style="height:28px;font-size:12px;padding:0 12px" :disabled="isDemo || passkeyBusy" @click="addPasskey">
      ...
      <div class="card-body" style="display:flex;flex-direction:column;gap:12px">
        ...
        <div v-else style="display:flex;flex-direction:column;gap:8px">
          ...
          >
            ...
            <button class="auth-pw-toggle" style="color:#e05c5c" :disabled="passkeyBusy" @click="removePasskey(cred.credentialId)" title="Passkey entfernen">
              <i class="ti ti-trash"></i>
            </button>
          </div>
        </div>
...
async function removePasskey(credentialId: string) {
  if (isDemo.value || !credentialId) return
