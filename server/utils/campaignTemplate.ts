// Freigestalt-Editor für Marketing-Lead-Seiten (/lead/[slug]) und Job-Ausschreibungen
// (/jobs/[id]) — Analogie zu invoiceTemplate.ts, aber ohne PDF/Puppeteer-Teil, da das
...
export function buildLeadTemplateData(campaign: any, form: any, branding: any = {}) {
...
export function buildJobTemplateData(campaign: any, branding: any = {}) {
  const brandName = branding?.brandName || 'Plexora'
...
export function renderCampaignHtml(templateHtml: string, data: any): string {
  try {
